    ...
    async function handleTotpConfirm(totpCode) {
        ...
        try {
            ...
            if (nextAttempts >= MAX_FAILED_ATTEMPTS) {
                ...
                setTotpError(mapPaymentError(err));
            }
        } finally {
            setSubmitting(false);
        }
                    ...
                    <form onSubmit={handleSubmit} noValidate>
                        ...
                        <div className="pay-section">
                            ...
                            <div className="pay-field">
                                ...
                                {errors.recipient_name && (
                                    <p className="pay-error-text">{errors.recipient_name}</p>
                                )}
                            </div>
                        ...
                        <div className="pay-section">
                            ...
                            <div className="pay-field">
                                ...
                                />
                                {errors.amount && (
                                    <p className="pay-error-text">{errors.amount}</p>
                                )}
                            </div>
                            ...
                            <div className="pay-field-row">
                                <div className="pay-field">
                                    ...
                                    />
                                    {errors.payment_code && (
                                        <p className="pay-error-text">{errors.payment_code}</p>
                                    )}
                                </div>
                                ...
                                <div className="pay-field">
                                    ...
                                    />
                                    {errors.purpose && (
                                        <p className="pay-error-text">{errors.purpose}</p>
                                    )}
                                </div>
                            </div>
